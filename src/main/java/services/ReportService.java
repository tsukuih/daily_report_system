...
public class ReportService extends ServiceBase {
    ...
    /**
     * 指定した従業員が作成した日報データを、指定されたページ数の一覧画面に表示する分取得しReportViewのリストを返却する
     * @param employee  従業員
     * @param page  ページ数
    ...
    /**
     * 指定したページ数の一覧画面に表示する日報データを取得し、ReportViewのリストに返却する
     * @param page  ページ数
     * @return  一覧画面に表示するデータのリスト
     */
    ...
    /**
     * 画面から入力された日報の登録内容を元にデータを1件取得し、日報テーブルに登録する
     * @param rv  日報の登録内容
